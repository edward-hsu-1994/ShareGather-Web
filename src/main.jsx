      ...
      <section className="hero">
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            <a className="button button-dark" href="https://apps.apple.com/tw/app/sharegather/id6793999691" target="_blank" rel="noreferrer">{t.appStore} <span>↗</span></a>
            <a className="button button-outline" href="#features">{t.seeHow} <span>↓</span></a>
